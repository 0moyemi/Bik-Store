...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 backdrop-blur-xl lg:backdrop-blur-md bg-card/60 lg:bg-card/80 border-b border-white/10 shadow-lg will-change-transform">
